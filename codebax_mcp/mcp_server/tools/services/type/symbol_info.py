                ...
                return GetSymbolInfoOutput(
                    ...
                    signature=SignatureInfo(
                        ...
                        return_type=ReturnType(
                            raw=symbol_data.get("signature"), normalized=NormalizedType(kind="unknown", types=[])
                        ),
                    ),
                    confidence=0.7,
    ...
    try:
        ...
        if not index_data:
            return FindSimilarUsagesOutput(
                symbol=input.symbol, similar_symbols=[], usages=[], total=0, notes="Index not found"
            )
        ...
        return FindSimilarUsagesOutput(
            symbol=input.symbol, similar_symbols=[], usages=[], total=0, notes=f"Error: {e!s}"
        )
