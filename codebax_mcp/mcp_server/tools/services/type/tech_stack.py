...
from codebax_mcp.mcp_server.models.output import GetTechStackPreferencesOutput, PackagePreference, CodingPattern
...
def _detect_python_packages(workspace_root: str) -> Dict[str, PackagePreference]:
    ...
    package_configs = {
        ...
        "orm": {
            "preferred": None,
            "candidates": ["SQLModel", "SQLAlchemy"],
            "installed": False,
            "notes": None
        },
        "logging": {
            "preferred": None,
            "candidates": ["logging", "structlog"],
            "installed": False,
            "notes": None
        },
        "di": {
            "preferred": None,
            "candidates": ["fastapi.Depends", "injector"],
            "installed": False,
            "notes": None
        }
    }
