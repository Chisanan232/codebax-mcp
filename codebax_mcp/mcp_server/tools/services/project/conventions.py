...
def _detect_test_config(workspace_root: str) -> dict[str, Any]:
    ...
    test_config = {"root": "tests", "framework": None, "file_patterns": [], "naming_style": None}
...
def _detect_source_config(workspace_root: str) -> dict[str, Any]:
    ...
    source_config = {"roots": [], "module_layout": None}
...
def _detect_style_config(workspace_root: str) -> dict[str, Any]:
    ...
    style_config = {
        "python": {"formatter": None, "type_checker": None},
        "typescript": {"formatter": None, "test_framework": None},
    }
...
def _detect_tooling_config(workspace_root: str) -> dict[str, Any]:
    ...
    tooling_config = {
        "python": {
            ...
            "test_command": None,
            "lint_commands": [],
            "pre_commit": {"enabled": False, "config": None, "run_command": None},
        },
        "node": {
            "manager": None,
            "root_package_json": None,
            "workspace": {"enabled": False, "tool": None, "config": None},
            "scripts": {"test": None, "lint": None, "build": None},
        },
        "jvm": {"build_tool": None, "wrapper": None, "subprojects": [], "test_command": None},
    }
...
def _detect_constraints(workspace_root: str) -> dict[str, Any]:
    ...
    return {"forbid_creating_dirs": [".git", "__pycache__", ".venv"], "prefer_existing_over_new": True}
