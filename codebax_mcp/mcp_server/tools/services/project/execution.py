...
def _detect_test_command(workspace_root: str) -> str:
    ...
    if os.path.exists(os.path.join(workspace_root, "pytest.ini")):
        return "pytest"
    elif os.path.exists(os.path.join(workspace_root, "package.json")):
        return "npm test"
...
def _detect_lint_command(workspace_root: str) -> str:
    ...
    if os.path.exists(os.path.join(workspace_root, "ruff.toml")):
        return "ruff check ."
    elif os.path.exists(os.path.join(workspace_root, ".eslintrc.json")):
        return "npm run lint"
...
def _detect_format_command(workspace_root: str) -> str:
    ...
    if os.path.exists(os.path.join(workspace_root, "ruff.toml")):
        return "ruff format ."
    elif os.path.exists(os.path.join(workspace_root, ".prettierrc")):
