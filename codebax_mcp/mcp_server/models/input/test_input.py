...
class LocateForSourceInput(BaseModel):
    ...
    source_path: str = Field(
        ...,
        description="Path to the source file (relative to workspace_root)"
    )
...
class CreateOrUpdateForSymbolInput(BaseModel):
    ...
    symbol: str = Field(
        ...,
        description="Name of the symbol (function, class, or method)"
    )
    language: str = Field(
        ...,
    ...
    intent: str = Field(
        ...,
        description="Operation intent - 'add_or_update' or 'delete'"
    )
    behavior_description: str = Field(
        ...,
        description="Description of what the symbol should do (for test generation)"
    )
    workspace_root: str = Field(
        default=".",
        description="Path to the workspace root directory"
