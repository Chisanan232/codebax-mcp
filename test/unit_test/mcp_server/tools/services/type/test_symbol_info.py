...
from codebax_mcp.mcp_server.models.input import FindSimilarUsagesInput, GetSymbolInfoInput
from codebax_mcp.mcp_server.models.output import FindSimilarUsagesOutput, GetSymbolInfoOutput
from codebax_mcp.mcp_server.tools.services.type.symbol_info import find_similar_usages, get_symbol_info
...
class TestGetSymbolInfo:
    ...
    def test_get_symbol_info_basic(self, mock_index):
        ...
        input_data = GetSymbolInfoInput(symbol="foo", language="python")
    ...
    def test_get_symbol_info_not_found(self, mock_index):
        ...
        input_data = GetSymbolInfoInput(symbol="nonexistent", language="python")
    ...
    def test_get_symbol_info_with_file(self, mock_index):
        ...
        input_data = GetSymbolInfoInput(symbol="foo", file="test.py", language="python")
...
class TestFindSimilarUsages:
    ...
    def test_find_similar_usages_basic(self, mock_index):
        ...
        input_data = FindSimilarUsagesInput(symbol="calculate", language="python")
    ...
    def test_find_similar_usages_no_matches(self, mock_index):
        ...
        input_data = FindSimilarUsagesInput(symbol="nonexistent", language="python")
    ...
    def test_find_similar_usages_partial_match(self, mock_index):
        ...
        input_data = FindSimilarUsagesInput(symbol="sum", language="python")
