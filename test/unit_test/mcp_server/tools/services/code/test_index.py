...
""")
    ...
    def test_index_codebase_basic(self, python_project):
        ...
        input_data = IndexCodebaseInput(workspace_root=str(python_project), full=True)
    ...
    def test_index_codebase_incremental(self, python_project):
        ...
        # First full index
        input_full = IndexCodebaseInput(workspace_root=str(python_project), full=True)
        index_codebase(input_full)

        # Then incremental
        input_incremental = IndexCodebaseInput(workspace_root=str(python_project), full=False)
    ...
    def test_index_codebase_with_specific_paths(self, python_project):
        ...
        input_data = IndexCodebaseInput(workspace_root=str(python_project), full=False, paths=["module1.py"])
    ...
    def test_index_codebase_nonexistent_directory(self):
        ...
        input_data = IndexCodebaseInput(workspace_root="/nonexistent/path", full=True)
