...
""")
    ...
    def test_get_conventions_node_project(self, node_project):
        ...
        input_data = GetConventionsInput(workspace_root=str(node_project), language="javascript")
        result = get_conventions(input_data)
    ...
    def test_get_conventions_with_specific_language(self, python_project):
        ...
        input_data = GetConventionsInput(workspace_root=str(python_project), language="python")
        result = get_conventions(input_data)
