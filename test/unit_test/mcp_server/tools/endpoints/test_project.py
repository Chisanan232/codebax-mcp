...
class TestProjectEndpoints:
    ...
    async def test_get_conventions_endpoint(self, mock_service):
        ...
        from codebax_mcp.mcp_server.models.output import (
            TestConventions, SourceConventions, StyleConventions,
            ToolingConventions, ProjectConstraints, PythonStyle, TypeScriptStyle,
            PythonTooling, NodeTooling, JvmTooling, PreCommitConfig,
            NodeWorkspace, NodeScripts
        )
        ...
        mock_service.return_value = ConventionsOutput(
            ...
            tooling=ToolingConventions(
                python=PythonTooling(
                    manager=None, entry=None, lock_files=[], test_command=None,
                    lint_commands=[], pre_commit=PreCommitConfig(enabled=False, config=None, run_command=None)
                ),
                node=NodeTooling(
                    manager=None, root_package_json=None,
