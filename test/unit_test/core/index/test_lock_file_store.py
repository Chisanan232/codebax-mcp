...
class TestLockFileStore:
    ...
    def sample_index_data(self):
        ...
        return {
            ...
            "symbol_usages": {},
            "metadata": {"indexed_at": "2024-01-01T00:00:00", "file_count": 1},
        }
    ...
    def test_save_with_special_characters(self, store):
        ...
        data = {"symbol": "test:function:foo:1", "path": "/path/to/file.py", "unicode": "Hello 世界 🌍"}
    ...
    def test_save_with_large_data(self, store):
        ...
        large_data = {f"symbol_{i}": {"name": f"func_{i}", "file": f"file_{i}.py"} for i in range(1000)}
    ...
    def test_save_with_lists(self, store):
        ...
        data = {"files": ["file1.py", "file2.py", "file3.py"], "counts": [1, 2, 3, 4, 5]}
