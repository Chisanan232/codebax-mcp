...
class TestInitializeServerEnvironment:
    ...
    @patch("codebax_mcp.entry.get_settings")
    @patch("codebax_mcp.entry.configure_logging")
...
class TestRunStandaloneServer:
    ...
    @patch("codebax_mcp.entry.initialize_server_environment")
    @patch("codebax_mcp.entry.mcp_factory")
...
class TestRunIntegratedServer:
    ...
    @patch("codebax_mcp.entry.initialize_server_environment")
    @patch("codebax_mcp.entry.integrated_factory")
    def test_run_integrated_success(self, mock_integrated_factory: MagicMock, mock_init_env: MagicMock) -> None:
        ...
        with patch("codebax_mcp.entry.uvicorn.run") as mock_uvicorn:
...
class TestMain:
    ...
    @patch("codebax_mcp.entry.run_integrated_server")
    @patch("codebax_mcp.entry.create_server_config")
    @patch("codebax_mcp.entry.parse_args")
    ...
    @patch("codebax_mcp.entry.run_standalone_server")
    @patch("codebax_mcp.entry.create_server_config")
    @patch("codebax_mcp.entry.parse_args")
